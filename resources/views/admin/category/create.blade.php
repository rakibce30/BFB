                ...
                <div class="card">
                    ...
                    <form class="forms-sample" action="{{route('category.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cat_name" class="form-control @error('cat_name') is-invalid @enderror" value="{{old('cat_name')}}" placeholder="Category Name">
                        </div>
                        @error('cat_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_title" value="{{old('meta_title')}}" class="form-control @error('meta_title') is-invalid @enderror"  placeholder="Meta Title">
                        </div>
                        @error('meta_title')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_key" value="{{old('meta_keyword')}}" class="form-control @error('meta_keyword') is-invalid @enderror "  placeholder="Meta Keyword">
                        </div>
                        @error('meta_keyword')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
